...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const revealTargets = document.querySelectorAll('.reveal-left, .reveal-right, .service-card.reveal-up, .why-card.reveal-up, .timeline-step.reveal-up, .gallery-item.reveal-up');
    ...
    form?.addEventListener('submit', async (e) => {
        ...
        if (!validateForm(data)) {
            if (formStatus) {
                formStatus.textContent = 'Please fill in the highlighted fields to continue.';
